...
def goal_distance_cost(vehicle, trajectory, predictions, data):
    ...
    if distance > 0:
        lane_offset = abs(2.0 * vehicle.goal_lane - data.intended_lane - data.final_lane)
        cost = 1 - exp(-lane_offset / distance)
...
def inefficiency_cost(vehicle, trajectory, predictions, data):
    ...
    cost = (2.0 * vehicle.target_speed - intended_speed - final_speed) / vehicle.target_speed
